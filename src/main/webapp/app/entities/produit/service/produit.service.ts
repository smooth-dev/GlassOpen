...
export class ProduitService {
  ...
  findByNomProduit(nomProduit: string): Observable<EntityArrayResponseType> {
    return this.http.get<IAnnexeOut[]>(`${this.resourceUrl}/${this.resource}/${nomProduit}`, { observe: 'response' });
  }
  generate(id: string): Observable<EntityResponseType> {
    return this.http.get<IProduit>(`${this.resourceUrl}/generate/${id}`, { observe: 'response' });
  }
